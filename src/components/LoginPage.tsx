  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden px-6">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute left-[-9rem] top-[-5rem] h-80 w-80 rounded-full bg-violet-600/20 blur-3xl" />
        <div className="absolute bottom-[-6rem] right-[-4rem] h-96 w-96 rounded-full bg-fuchsia-500/16 blur-3xl" />
      </div>

      <div className="w-full max-w-md">
        <div className="rounded-3xl border border-violet-400/12 bg-[#130c24]/82 p-8 shadow-[0_28px_70px_rgba(4,2,12,0.55)] backdrop-blur-xl">
        ...
        <p className="mt-8 text-center text-sm text-violet-200/70">
          Discover and access the most powerful AI models across all categories.
        </p>
      </div>
    </div>
  );
